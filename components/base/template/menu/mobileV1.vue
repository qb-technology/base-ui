...
const props = defineProps({
  menu: {
    ...
    default: () => ({
      items: [
        ...
        {
          label: 'Tracker',
          icon: 'i-solar-graph-new-outline'
        },
        {
          label: 'Articles',
      ...
      ui: {
        link: 'flex-col justify-center text-xs',
  ...
  // items: {
  //   type: Array as PropType<MaybeArrayOfArray<NavigationMenuItem>>,
  //   default: () => ([
  //     {
  //       label: 'Home',
  //       icon: 'i-solar-home-angle-bold',
